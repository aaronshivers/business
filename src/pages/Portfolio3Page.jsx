...
import Portfolio3Item from '../components/Portfolio3Item'
...
const Portfolio3Page = () => {
  ...
  return (
    <Container>
      <Heading heading="portfolio 3" subheading="subheading" />
      <BreadcrumbContainer location="portfolio 3" />
      <Row>
        {
          portfolioData.map((item, i) => {
            ...
            return (
              i >= start && i < end && <Portfolio3Item key={i} {...item} />
            )
          })
        }
      </Row>
