...
const paragraph = "The page you're looking for could not be found. Here are some helpful links to get you back on track:"
      ...
      <ul>
        ...
        <li className="text-capitalize">
          ...
          <ul>
            ...
            <li><Link to="/faq" className="text-uppercase">faq</Link></li>
