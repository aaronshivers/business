...
import Portfolio4Item from '../components/Portfolio4Item'
...
const Portfolio4Page = () => {
  ...
  return (
    <Container>
      <Heading heading="portfolio 4" subheading="subheading" />
      <BreadcrumbContainer location="portfolio 4" />
      <Row>
        {
          portfolioData.map((item, i) => {
            ...
            return (
              i >= start && i < end && <Portfolio4Item key={ i } { ...item } />
            )}
          )
        }
      </Row>
